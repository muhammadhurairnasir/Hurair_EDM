...
import { LayoutDashboard, ShoppingBag, UtensilsCrossed, Users, Tag, Settings, TableProperties, ExternalLink } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const allNavItems = [
    { name: 'Store Operations', path: '/dashboard', icon: LayoutDashboard, roles: ['restaurant_owner'] },
    { name: 'Orders', path: '/orders', icon: ShoppingBag, roles: ['restaurant_owner'] },
    { name: 'Products', path: '/menu', icon: UtensilsCrossed, roles: ['restaurant_owner'] },
    { name: 'Coupons', path: '/coupons', icon: Tag, roles: ['restaurant_owner'] },
    ...
    { name: 'Settings', path: '/settings', icon: Settings, roles: ['restaurant_owner'] },
  ];
